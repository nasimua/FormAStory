# FormAStory
## Codecademy Project (Focus: HTML Forms)
...
*Note: Only the index.html file was edited as part of this project. All other files were provided, completed by codecademy*
